...
describe('PhotographPotentialComputer', () => {
    ...
    it('should compute 0 if no common tags', () => {
        ...
        let computer = new PhotographPotentialComputer()
